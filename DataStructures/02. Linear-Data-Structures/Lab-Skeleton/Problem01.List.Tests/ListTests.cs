namespace Problem01.List.Tests
{
    ...
    public class ListTests
    {
        ...
        [Test]
        public void Indexer_GetInvalidElement_ShouldThrowException([Values(-1, 1, 3, -5, int.MinValue, int.MaxValue)] int index)
        {
            this.list.Add(10);
        ...
        [Test]
        public void Indexer_SetInvalidElement_ShouldThrowException([Values(-1, 1, 3, -5, int.MinValue, int.MaxValue)] int index)
        {
            this.list.Add(10);
